...
class seed_data:
    def __init__(self):
        ...
        self.__data = [
            ...
            {'line_number': {"N":"9"},'sent':{"N":"0"},"line":{"S":"Are you a magician? Because whenever I look at you, everyone else disappears!"}},
            {'line_number': {"N":"10"},'sent':{"N":"0"},"line":{"S":"Are you a camera? Because every time I look at you, I smile."}},
            {'line_number': {"N":"11"},'sent':{"N":"0"},"line":{"S":"Do you work at Starbucks? Because I like you a latte."}},
